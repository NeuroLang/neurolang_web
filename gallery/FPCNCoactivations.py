...
ProbActivationGivenNetworkActivation(r, n, PROB) :- (RegionReported(r, s) & SelectedStudy(s)) // (NetworkReported(n, s) & SelectedStudy(s))
ProbActivationGivenNoNetworkActivation(r, n, PROB) :- (RegionReported(r, s) & SelectedStudy(s)) // (~NetworkReported(n, s) & Network(n) & SelectedStudy(s))
ProbActivation(r, PROB) :- RegionReported(r, s) & SelectedStudy(s)
...
ProbRegionAndNetworkReported(r, n, PROB) :- RegionReported(r, s) & NetworkReported(n, s) & SelectedStudy(s)
