...
ProbTopicAssociationGivenNetworkActivation(t, n, PROB) :- (TopicAssociation(t, s) & SelectedStudy(s)) // (NetworkReported(n, s) & SelectedStudy(s))
ProbTopicAssociationGivenNoNetworkActivation(t, n, PROB) :- (TopicAssociation(t, s) & SelectedStudy(s)) // (~NetworkReported(n, s) & Network(n) & SelectedStudy(s))
ProbTopicAssociation(t, PROB) :- TopicAssociation(t, s) & SelectedStudy(s)
...
ProbNetworkReported(n, PROB) :- NetworkReported(n, s) & SelectedStudy(s)
CountStudiesNetworkReported(n, scount) :- ProbNetworkReported(n, prob) & CountStudies(N) & (scount == prob * N)
ProbTopicAssociationAndNetworkReported(t, n, PROB) :- TopicAssociation(t, s) & NetworkReported(n, s) & SelectedStudy(s)
